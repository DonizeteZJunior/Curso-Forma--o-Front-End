...
const saveTodo = (text, done = 0, save = 1) => {
    ...
    //Criando e adicionando o titulo ao div
    const todoTitle = document.createElement("h3");
    todoTitle.innerText = text;
    todo.appendChild(todoTitle);
    //Cria os botões, adiciona neles a classe correspondente e o html com o icone, para depois adicionar a div
...
document.addEventListener("click", (e) => {
    ...
    // Busca o elemento mais proximo da onde foi o click
